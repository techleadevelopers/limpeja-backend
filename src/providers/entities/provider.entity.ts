...
export class ProviderEntity implements PrismaProvider {
  ...
  @ApiPropertyOptional({
    description: 'Data de nascimento do provedor',
    example: '1990-05-15T00:00:00.000Z',
  })
  dateOfBirth: Date | null; // Pode ser nulo

  @ApiPropertyOptional({
    description: 'Número de telefone do provedor',
    example: '11987654321',
  })
  phone: string | null;

  @ApiPropertyOptional({
    description: 'ID do endereço do provedor',
  ...
  @ApiPropertyOptional({
    ...
    example: 'Profissional dedicada à limpeza há 5 anos.',
  })
  bio: string | null;
  ...
  @ApiPropertyOptional({
    description: 'URL da selfie com o documento',
    example: 'https://example.com/selfie-doc.jpg',
  })
  selfieWithDocumentUrl: string | null;

  @ApiPropertyOptional({
    description: 'Resultado da verificação de antecedentes',
    example: { criminal: 'clear' },
  })
  backgroundCheckResult: Prisma.JsonValue | null;

  @ApiPropertyOptional({
    description: 'Motivo da rejeição da verificação',
    example: 'Documento ilegível',
  })
  rejectionReason: string | null;

  @ApiPropertyOptional({
    description: 'Chave PIX do provedor',
    example: '123.456.789-00',
  })
  pixKey: string | null;

  @ApiPropertyOptional({
    description: 'Chave PIX mascarada para exibição',
    example: '123****-00',
  })
  ...
  @ApiPropertyOptional({
    description: 'Resultado do OCR no documento',
    example: { name: 'João da Silva' },
  })
  ocrResult: Prisma.JsonValue | null;

  @ApiPropertyOptional({
    description: 'Resultado da verificação de vivacidade',
    example: { score: 0.95 },
  })
  livenessResult: Prisma.JsonValue | null;

  @ApiProperty({
    description: 'Data de criação do provedor',
    example: '2023-01-01T10:00:00.000Z',
  })
  createdAt: Date;

  @ApiProperty({
    description: 'Data da última atualização do provedor',
    example: '2023-01-01T10:00:00.000Z',
  })
  updatedAt: Date;
  ...
  @ApiProperty({
    description: 'Contagem de avaliações 5 estrelas recebidas',
    example: 50,
  })
  fiveStarReviewCount: number;

  @ApiProperty({
    description: 'Contagem de agendamentos concluídos no mês atual',
    example: 20,
  })
  ...
  @ApiProperty({
    description: 'Lista de badges do provedor',
    example: ['VERIFIED', 'TOP_RATED'],
  })
  badges: string[];
