...
class SearchResultDto {
  @ApiProperty({ type: [ProviderDetailsDto], description: 'Resultados de provedores (com sinais premium opcionais)' })
  ...
  @ApiProperty({ description: 'Resultados principais de serviços de provedores (com distance, nextAvailable, etc.)', type: 'array', items: { type: 'object' } })
...
export class SearchController {
  ...
  @Get()
  @ApiOperation({ summary: 'Realizar uma busca abrangente por provedores, serviços, etc. (inclui sinais premium opcionais)' })
