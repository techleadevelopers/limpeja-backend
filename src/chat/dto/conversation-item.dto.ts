...
export class ConversationItemDto {
  ...
  @ApiProperty({
    description: 'ID do outro participante da conversa',
    example: 'uuid-do-usuario-456',
  })
  otherUserId: string;

  @ApiProperty({
    description: 'Nome do outro participante da conversa',
    example: 'João da Silva',
  })
  otherUserName: string;

  @ApiProperty({
    description: 'URL do avatar do outro participante (opcional)',
    required: false,
  ...
  @ApiProperty({
    description: 'Timestamp da última mensagem (ISO 8601)',
