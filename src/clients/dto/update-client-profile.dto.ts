...
export class UpdateClientProfileDto {
  @ApiPropertyOptional({ description: 'Nome completo do cliente', example: 'Maria da Silva Atualizada' })
  @IsOptional()
  @IsString()
  fullName?: string;

  @ApiPropertyOptional({ description: 'Número de telefone do cliente (formato internacional)', example: '+5511987654321' })
  @IsOptional()
  @IsString()
