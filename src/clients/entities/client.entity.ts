import { Client as PrismaClient, User, Address, Booking, Review, Subscription, GuaranteeClaim } from '@prisma/client';
...
export class ClientEntity implements PrismaClient {
  ...
  @ApiPropertyOptional({ description: 'Data de nascimento do cliente', example: '1990-01-01T00:00:00.000Z' })
  ...
  @ApiProperty({ description: 'Contagem de não comparecimentos do cliente', example: 0 })
  noShowCount: number;

  @ApiProperty({ description: 'Contagem de cancelamentos do cliente', example: 0 })
