...
import { IsString, IsNumber, IsOptional, IsUrl, IsArray, IsEnum } from 'class-validator';
...
export class ProviderRankingDto {
  ...
  @ApiPropertyOptional({ description: 'Status de verificação (para selo)', enum: VerificationStatus })
  @IsOptional()
  @IsEnum(VerificationStatus)
  verificationStatus?: VerificationStatus;

  @ApiPropertyOptional({ description: 'Taxa de aceitação (para métricas)', example: 90 })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({ description: 'Próximo horário disponível', example: { date: '2025-09-29', time: '09:00' } })
  @IsOptional()
  nextAvailable?: { date: string; time: string };

  @ApiPropertyOptional({ description: 'Badges do provedor', type: [String], example: ['TOP_RATED'] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  badges?: string[];
