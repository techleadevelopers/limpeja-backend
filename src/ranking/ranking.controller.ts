...
export class RankingController {
  ...
  @ApiQuery({
    name: 'sortBy',
    enum: SortByOption,
    description: 'Critério de ordenação (padrão: Rating)',
  ...
  async getLocalProviderRanking(
    ...
    return this.rankingService.getProviderRanking(
      latitude,
      longitude,
      radius,
      sortBy,
  ...
  @ApiOperation({
    summary: 'Obter a posição de um provedor específico no ranking local',
  })
  @ApiQuery({
    name: 'latitude',
    type: Number,
  ...
  async getProviderPosition(
    ...
    return this.rankingService.getProviderPositionInRanking(
      providerId,
      latitude,
      longitude,
      radius,
