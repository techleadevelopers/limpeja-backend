...
export class TransactionEntity implements PrismaTransaction {
  ...
  @ApiProperty({
    description: 'ID do provedor envolvido na transação',
  ...
  @ApiPropertyOptional({
    ...
    example: 'Pagamento de serviço de limpeza',
  })
  ...
  @ApiPropertyOptional({
    description: 'ID do agendamento associado à transação (se houver)',
  ...
  @ApiPropertyOptional({
    description:
      'ID da transação no gateway de pagamento (PagSeguro, Stripe, etc.)',
    example: 'pagseguro-txn-12345',
    nullable: true,
  })
  ...
  @ApiPropertyOptional({
    description:
      'URL do QR Code gerado pelo gateway de pagamento (se aplicável)',
  ...
  @ApiPropertyOptional({
    description:
      'Referência interna para transações (ex: ID da assinatura para pagamentos recorrentes)',
    example: 'recurring_sub_123',
    nullable: true,
  })
  ...
  @ApiPropertyOptional({
    description: 'ID do cupom associado à transação (se houver)',
  ...
  @ApiPropertyOptional({
    description: 'Tipo da chave PIX utilizada para o saque',
    enum: PixKeyType,
