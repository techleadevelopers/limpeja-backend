import { Controller, Get, Post, Body, Req, UseGuards, HttpStatus, Headers } from '@nestjs/common';
...
export class EarningsController {
  ...
  async requestWithdrawal(
    ...
    return await this.earningsService.requestWithdrawal((req as any).user.userId, withdrawalDto, idempotencyKey);
  }
}
