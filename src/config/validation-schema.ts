...
export const validationSchema = Joi.object({
  ...
  // Redis: aceite interno (REDIS_URL) ou público (REDIS_URL_PUBLIC)
  ...
  THIRD_PARTY_FACEMATCH_API_KEY: Joi.string().required()
  ...
  .messages({
    'object.missing': 'Configuração inválida: defina REDIS_URL (interno) ou REDIS_URL_PUBLIC (público).',
  });
