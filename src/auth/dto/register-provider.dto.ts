...
export class RegisterProviderDto {
  @ApiProperty({
    description: 'Endereço de e-mail do provedor',
    example: 'provedor@example.com',
  })
  ...
  @Length(11, 14, {
    message: 'O CPF deve ter entre 11 e 14 caracteres (com ou sem formatação).',
  })
  cpf: string;

  @ApiProperty({
    description: 'Data de nascimento do provedor (ISO 8601)',
    example: '1990-01-01',
  })
  ...
  @IsDateString(
    ...
    {
      message:
        'A data de nascimento deve ser uma string de data válida (ISO 8601).',
    },
  )
  dateOfBirth: string;
  ...
  @ApiProperty({
    ...
    description: 'Dados do endereço do provedor',
  })
